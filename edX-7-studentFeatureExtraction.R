...
#   2018.04.30  Update code to align data input and output directories and finding 
#               correct files (course ID, student demographic data, logs).
#               Remove unused data function.
#   2018.05.17  Code extracted from visualization script that creates additional
#               fields to the data set translated for use in this script; removal
#               of fields calculating the average date of video and problem modules; 
#               exported data. Converted courseStr that used full course structure 
#               object to updated organization of fields in into courseMeta object 
#               that imports basic metadata; updated package requirements, and 
#               added navigation headers to script.
#   2018.09.12  Update script description; tested with additional course data sets.
#
## ====================================================================================== ##
#### Environment Setup ####
rm(list=ls()) 
