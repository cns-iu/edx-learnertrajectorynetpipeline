...
# Loading Data
The data set loaded as students was created by the script [edX-7-studentFeatureExtraction.R](https://github.com/cns-iu/edx-learnertrajectorynetpipeline/blob/master/edX-7-studentFeatureExtraction.R). Data represents overall engagement statistics for each active student's for the length of the course.
