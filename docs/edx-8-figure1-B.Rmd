---
title: "Figure 1 B - Visualizing Difference Between Instructor Estimate and Students Use Time to Unit Completion"
---
...
#Estimates of Time to Completion for edX Course Chapters and Sequential Pages
...
##Extracting Chapter Estimates of Time to Completion
...
##Extracting Sequential Estimates of Time to Completion
Estimates of time to completion are also provided for sequential page, which group content and assessment modules into sub-units of a chapter. The nested structure allows for more nuanced estimates of time to completion than for chapters provide. Time to completion estimates for sequential pages are used for this figure.
...
Note, some sequential pages do not have estimates for the time necessary to completion. For the course profiled, the page modules without time to completion estimates happen to be survey instruments administed by instructional designers. 
...
Now that the estimates of time to complete a sequential page and the total average time taken by students on sequenial page modules can be combined into a single dataframe.
...
##Visualization of Fig 1 - Inset B: Avg Student Temporal Module Page Use Compared to Estimated Time Use
