...
```{r figure 5A, fig.height=7, fig.width=5}
p1 <- ggplot(mod_event[mod_event$module.type=="html+block",], aes(x=order,y=val2)) +
        ...
        labs(y="Mean Interaction Events per Student", title="A") +
...
```{r figure 5B, fig.height=7, fig.width=5}
...
```{r figure 5C, fig.height=7, fig.width=5}
