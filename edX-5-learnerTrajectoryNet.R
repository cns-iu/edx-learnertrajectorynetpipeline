...
#               more CSV student edge lists:
#               - {userID}-nodes.csv;
#            3) A project directory "./networks/edges/" containing one or 
#               more sets of CSV student node lists:
#               - {userID}-edges.csv;
